...
namespace ConsoleApp265
{
    public class PrecoDosProdutos
    {
        ...
        public PrecoDosProdutos() { }


        public PrecoDosProdutos(double farinha, double ovos, double leite, double açucar, double fermento, double sal, double manteiga, double oleo)
        {
            Farinha = farinha;
            Ovos = ovos;
            Leite = leite;
